...
namespace Projet_banque_II
{
    ...
    {
        public int id_gs { get; }
        public string type_gs { get; }
        public int nb_trs { get; }
        public decimal frais_gs { get; set; }
        public List<int> comptes { get; set; }

        public Gestionnaire(int id, string tp, int nb, decimal frais, List<int> cs)
        {
            id_gs = id;
            type_gs = tp;
            nb_trs = nb;
