...
namespace Projet_banque_III
{
    ...
    public class CompteLivret : Compte
    {
        ...
        public CompteLivret(int id, string tp, DateTime dc, DateTime dr, decimal s, List<Tuple<DateTime, int>> gs, List<Tuple<DateTime, decimal>> hs, decimal interet_an)
            : base(id, tp, dc, dr, s, gs, hs)
        { int_a = interet_an; }
    }
    ...
    {
        public decimal int_a;
        public CompteATerme(int id, string tp, DateTime dc, DateTime dr, decimal s, List<Tuple<DateTime, int>> gs, List<Tuple<DateTime, decimal>> hs, decimal interet_an)
            : base(id, tp, dc, dr, s, gs, hs)
        { int_a = interet_an; }
    }
}
